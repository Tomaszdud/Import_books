...
class BookSearchForm(forms.Form):
    ...
    published_date_from = forms.DateField(required=False,
                                          widget=forms.SelectDateWidget(years=range(1000, current.year+1)))
    published_date_to = forms.DateField(required=False,
                                        widget=forms.SelectDateWidget(years=range(1000, current.year+1)))
    language = forms.CharField(required=False, label='Language (acronym)')
